...
def recommend (uploads):
    ...
    response = client.responses.create(
        ...
        + " Utilise strong colour theory and have good sense of fashion, they must look good with your recommendations. Your recomendations must be of the form <type of clothe>, <colour> where"
